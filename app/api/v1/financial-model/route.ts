...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    logger.info('Financial model request', { userId: user.id });
    ...
    const requiredFields = ['businessName', 'industry', 'stage'];
    ...
    const result = await service.generateFinancialModel(user.id, body);
    ...
    return NextResponse.json({
      ...
      data: {
        sessionId: result.sessionId,
        financialModel: result.financialModel,
