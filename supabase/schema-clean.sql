...
-- Safe version that drops existing policies before recreating
...
DROP POLICY IF EXISTS "Users can create own responses" ON questionnaire_responses;
DROP POLICY IF EXISTS "Users can update own responses" ON questionnaire_responses;
DROP POLICY IF EXISTS "Users can view own business models" ON business_models;
DROP POLICY IF EXISTS "Users can create own business models" ON business_models;
DROP POLICY IF EXISTS "Users can view own MCP logs" ON mcp_analysis_logs;
...
-- ==========================================
-- POLICIES (Recreated after dropping above)
-- ==========================================
...
DROP TRIGGER IF EXISTS update_responses_updated_at ON questionnaire_responses;
...
AND table_name IN ('users', 'questionnaire_sessions', 'questionnaire_responses', 'business_models', 'mcp_analysis_logs');
